...
// NewDate - helper function to easily create date from ISO format `YYYY-MM-DD`
...
//	GetLastDayOfMonth(2019-02-03) => february has 28 days, so returns 28 (or 29 if year is leap)
//	GetLastDayOfMonth(2020-02-06) => 29, because 2020 is a leap year
